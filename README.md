...
Join the discord here: https://discord.gg/86cwKxkF
...
- Electronics ~50€ + the power supply ~50€
...
[Part list](Parts/Part_list_electronics.xlsx)
...
The gerber files are available [here](PCB/Gerber_Enderspark_PCB_Enderspark_2_2026-01-28.zip) with [design files](PCB), the requiered components are listed [here](Parts/Part_list_electronics.xlsx) the design requier no vias so you can DIY it but if you're laizy like me you can order it to JLCPCB
