...
The overall cost is about 250€ without the 3D printer separated in 3 cathegories:
- Electronics ~40€
...
A few modifications of the firmware are requiered and listed [here](Code/Firmware_ender3V2/Modifications_list)
The configuration.h, configuration_adv.h and pins.h for an ender3V2 are also availlable [Ender3V2](Code/Firmware_ender3V2)
